...
const SecondaryContent = () => {
  ...
  return (
    <>
      ...
      {basedOnTrueStories.length > 0 && <ContentRow title={t('home.sections.basedOnTrueStories', 'Based on True Stories')} media={basedOnTrueStories} />}

      {/* Genre-Based Rows (all with infinite scroll) */}
      {actionMovies.length > 0 && (
        <ContentRow
          title={t('home.sections.action', 'Action')}
          media={actionMovies}
      ...
      {comedyMovies.length > 0 && (
        <ContentRow
          title={t('home.sections.comedy', 'Comedy')}
          media={comedyMovies}
      ...
      {dramaMovies.length > 0 && (
        <ContentRow
          title={t('home.sections.drama', 'Drama')}
          media={dramaMovies}
      ...
      {thrillerMovies.length > 0 && (
        <ContentRow
          title={t('home.sections.thriller', 'Thriller')}
      ...
      {sciFiMovies.length > 0 && (
        <ContentRow
          title={t('home.sections.sciFi', 'Sci-Fi')}
          media={sciFiMovies}
      ...
      {horrorMovies.length > 0 && (
        <ContentRow
          title={t('home.sections.horror', 'Horror')}
          media={horrorMovies}
      ...
      {romanceMovies.length > 0 && (
        <ContentRow
          title={t('home.sections.romance', 'Romance')}
          media={romanceMovies}
      ...
      {animationMovies.length > 0 && (
        <ContentRow
          title={t('home.sections.animation', 'Animation')}
      ...
      {familyMovies.length > 0 && (
        <ContentRow
          title={t('home.sections.family', 'Family')}
          media={familyMovies}
      ...
      {documentaryMovies.length > 0 && (
        <ContentRow
          title={t('home.sections.documentary', 'Documentary')}
      ...
      {mysteryMovies.length > 0 && (
        <ContentRow
          title={t('home.sections.mystery', 'Mystery')}
          media={mysteryMovies}
      ...
      {fantasyMovies.length > 0 && (
        <ContentRow
          title={t('home.sections.fantasy', 'Fantasy')}
          media={fantasyMovies}
      ...
      {/* Binge/For Kids */}
      {bingeSeries.length > 0 && <ContentRow title={t('home.sections.bingeSeries', 'Binge-Worthy Series')} media={bingeSeries} />}
      {moviesForKids.length > 0 && <ContentRow title={t('home.sections.moviesForKids', 'Movies for Kids')} media={moviesForKids} />}

      {/* Regional/Language Rows */}
      {hollywoodMovies.length > 0 && <ContentRow title={t('home.sections.hollywood', 'Hollywood')} media={hollywoodMovies} />}
      {bollywoodMovies.length > 0 && <ContentRow title={t('home.sections.bollywood', 'Bollywood')} media={bollywoodMovies} />}
      {koreanDramas.length > 0 && <ContentRow title={t('home.sections.koreanDramas', 'Korean Dramas')} media={koreanDramas} />}
      {japaneseAnime.length > 0 && <ContentRow title={t('home.sections.japaneseAnime', 'Japanese Anime')} media={japaneseAnime} />}
      {europeanCinema.length > 0 && <ContentRow title={t('home.sections.europeanCinema', 'European Cinema')} media={europeanCinema} />}

      {/* Platform/Provider Rows */}
      {youTubeOriginals.length > 0 && <ContentRow title={t('home.sections.youTubeOriginals', 'YouTube Originals')} media={youTubeOriginals} />}
      {hboMax.length > 0 && <ContentRow title={t('home.sections.hboMax', 'HBO Max')} media={hboMax} />}
      {peacock.length > 0 && <ContentRow title={t('home.sections.peacock', 'Peacock')} media={peacock} />}
      {crunchyroll.length > 0 && <ContentRow title={t('home.sections.crunchyroll', 'Crunchyroll')} media={crunchyroll} />}
    </>
  );
};
