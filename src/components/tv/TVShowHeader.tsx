...
import { Tv, Heart, Bookmark, History, Play, Calendar, Star, List, Shield, Download } from 'lucide-react';
    ...
    <div className="relative w-full h-[70vh]">
      {!backdropLoaded && (
        <div className="absolute inset-0 bg-background image-skeleton" />
          ...
          <img
        src={getImageUrl(tvShow.backdrop_path, backdropSizes.original) || '/placeholder.svg'}
            ...
            <div className="flex flex-wrap gap-3">
              ...
              {lastWatchedEpisode && (
                ...
                >
                  ...
                  {t('tv.continue', { season: lastWatchedEpisode.season, episode: lastWatchedEpisode.episode, progress: lastWatchedEpisode.progress })}
                </Button>
              )}
