...
export const TVShowAbout = ({ tvShow }: TVShowAboutProps) => {
  ...
  return (
    <div className="mb-8">
      <h2 className="text-2xl font-bold text-white mb-6">{t('media.tabs.about')}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="glass p-6 rounded-xl">
          <h3 className="text-lg font-semibold text-white mb-3">{t('media.tabs.reviews', 'Episodes').includes('Episodes') ? t('media.episodes', 'Episodes') : t('media.episodes', 'Episodes')}</h3>
          <p className="text-white/80">{tvShow.number_of_episodes}</p>
        </div>
        
        <div className="glass p-6 rounded-xl">
          <h3 className="text-lg font-semibold text-white mb-3">{t('tv.season', 'Season')}s</h3>
      ...
      {tvShow.production_companies.length > 0 &&
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-white mb-4">{t('media.productionCompanies', 'Production Companies')}</h3>
