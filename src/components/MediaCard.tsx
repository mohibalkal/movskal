    ...
    return (
      ...
      >
        <div className="relative h-full rounded-md overflow-hidden shadow-md">
          ...
          <img
            src={imageError || !media.poster_path || !getImageUrl(media.poster_path, posterSizes.medium) ? '/placeholder.svg' : getImageUrl(media.poster_path, posterSizes.medium)}
    ...
    >
      <motion.div>
        <div className="relative rounded-md overflow-hidden shadow-md aspect-[2/3]">
          ...
          <img
            src={imageError || !media.poster_path ? '/placeholder.svg' : getImageUrl(media.poster_path, posterSizes.medium)}
            alt={media.title || media.name || 'Media Poster'}
